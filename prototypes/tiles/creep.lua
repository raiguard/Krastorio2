...
data:extend(
{
	...
	{	
		...
		variants = tile_variations_template
			(
				kr_tiles_path .. "creep/creep-1.png", "__base__/graphics/terrain/masks/transition-4.png",
				kr_tiles_path .. "creep/hr-creep-1.png", "__base__/graphics/terrain/masks/hr-transition-4.png",
				{
					max_size = 8,
