if mods["angelsaddons-smeltingtrain"] then
  ...
  data.raw["locomotive"]["smelting-locomotive-1"].burner.emissions_per_minute = { pollution = 20 }
  ...
  data.raw["locomotive"]["smelting-locomotive-tender"].burner.emissions_per_minute = { pollution = 20 }
