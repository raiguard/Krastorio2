...
if suppress_krastorio_assertions ~= true then
  ...
  local any_angel = 
  mods["angelsaddons-cab"] or
  mods["angelsaddons-crawlertrain"] or
  mods["angelsaddons-petrotrain"] or
  mods["angelsaddons-smeltingtrain"] or
  mods["angelsbioprocessing"] or
  mods["angelsindustries"] or
  mods["angelspetrochem"] or
  mods["angelsrefining"] or
  mods["angelssmelting"]

  if any_bob and any_angel then
    krastorio.general.printWarningMessage(krastorio_assertions[1], "Any Bob's mod with any Angel's mod can't be used with Krastorio 2!\n(This is not a bug, it's a fact, don't report this to mod developers).")
  end
