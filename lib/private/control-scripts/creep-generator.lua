...
return
{
	{ creepVariablesInitializing, "on_init" },      -- For setup variables
	{ pushCreepToGenerate, "on_biter_base_built" }, -- For migration
	{ pushCreepToGenerate, "on_chunk_generated" },  -- For nests generated by game
	{ continueCreepGeneration, "on_tick" }         -- Creep generation processed slowly
}
