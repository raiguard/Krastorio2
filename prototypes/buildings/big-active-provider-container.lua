...
data:extend({
  ...
  },
  {
    type = "item",
    name = "kr-big-active-provider-container",
    icon = "__Krastorio2Assets__/icons/entities/big-active-provider-container.png",
    subgroup = "kr-logistics-3",
    order = "b[big-active-provider-container]",
  ...
  },
  {
    ...
    animation = {
      filename = "__Krastorio2Assets__/entities/big-active-provider-container/big-active-provider-container.png",
      priority = "extra-high",
      width = 512,
      height = 512,
      frame_count = 6,
