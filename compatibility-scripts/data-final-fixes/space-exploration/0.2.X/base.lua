...
require("__Krastorio2__/compatibility-scripts/data-final-fixes/space-exploration/0.2.X/technology")

if mods["space-exploration"] and krastorio.general.isVersionLesserEqualThan(mods["space-exploration"], "0.2.999") then
