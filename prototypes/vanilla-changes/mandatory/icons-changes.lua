...
data.raw.tool["automation-science-pack"].icon = kr_technologies_icons_path .. "automation-tech-card.png"
...
data.raw.tool["logistic-science-pack"].icon = kr_technologies_icons_path .. "logistic-tech-card.png"
data.raw.tool["logistic-science-pack"].icon_size = 64
data.raw.tool["logistic-science-pack"].order = "03[logistic-tech-card]"

-- Military science pack
data.raw.tool["military-science-pack"].icon = kr_technologies_icons_path .. "military-tech-card.png"
data.raw.tool["military-science-pack"].icon_size = 64
data.raw.tool["military-science-pack"].order = "04[military-tech-card]"

-- Chemical science pack
data.raw.tool["chemical-science-pack"].icon = kr_technologies_icons_path .. "chemical-tech-card.png"
data.raw.tool["chemical-science-pack"].icon_size = 64
data.raw.tool["chemical-science-pack"].order = "05[chemical-tech-card]"

-- Production science pack
data.raw.tool["production-science-pack"].icon = kr_technologies_icons_path .. "production-tech-card.png"
...
data.raw.tool["utility-science-pack"].icon = kr_technologies_icons_path .. "utility-tech-card.png"
data.raw.tool["utility-science-pack"].icon_size = 64
data.raw.tool["utility-science-pack"].order = "07[utility-tech-card]"

-- Space science pack
data.raw.tool["space-science-pack"].icon = kr_technologies_icons_path .. "space-tech-card.png"
