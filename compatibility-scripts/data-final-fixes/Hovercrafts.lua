if mods["Hovercrafts"] then 
  ...
  if krastorio.general.getSafeSettingValue("enable-mcraft") and
     (
        ( mods["electric-vehicles-lib-reborn"] or mods["laser_tanks"] ) and
      krastorio.general.getSafeSettingValue("lasertanks-electric-engine")
     )
  then
    createEGrid()
