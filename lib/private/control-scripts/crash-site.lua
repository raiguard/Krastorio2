...
if not remote.interfaces["kr-crash-site"] then
  remote.add_interface("kr-crash-site", {
    ...
    add_crash_site_entity = function(entity_name)
    ...
    remove_crash_site_entity = function(entity_name)
      if type(entity_name) ~= "string" then
