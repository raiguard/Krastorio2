...
data:extend({
  ...
  },
  {
    ...
    hand_closed_picture = {
      filename = "__Krastorio2Assets__/buildings/superior-inserters/superior-inserter/superior-inserter-hand-closed.png",
      priority = "extra-high",
      width = 100,
      height = 164,
      scale = 0.25,
    ...
    hand_open_picture = {
      filename = "__Krastorio2Assets__/buildings/superior-inserters/superior-inserter/superior-inserter-hand-open.png",
      priority = "extra-high",
      width = 130,
      height = 164,
      scale = 0.25,
