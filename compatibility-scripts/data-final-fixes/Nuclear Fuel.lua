...
if mods["Nuclear Fuel"] then
	...
	krastorio.recipes.multiplyIngredient("nuclear-fuel-reprocessing", "used-up-uranium-fuel-cell", nuclear_fuel_cycle_ingredient_multiplier)
	...
	krastorio.recipes.replaceIngredient("breeder-fuel-reprocessing", "used-up-breeder-fuel-cell", {"used-up-breeder-fuel-cell", 2})
