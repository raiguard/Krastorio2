...
data:extend({
  ...
  },
  {
    type = "item",
    name = "kr-big-passive-provider-container",
    icon = "__Krastorio2Assets__/icons/entities/big-passive-provider-container.png",
    subgroup = "kr-logistics-3",
    order = "d[big-passive-provider-container]",
  ...
  },
  {
    ...
    animation = {
      filename = "__Krastorio2Assets__/entities/big-passive-provider-container/big-passive-provider-container.png",
      priority = "extra-high",
      width = 512,
      height = 512,
      frame_count = 6,
