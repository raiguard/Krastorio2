kr_superior_transport_belt_animation_set = 
{
	animation_set =
	{
		filename = kr_entities_path .. "transport-belts/superior-transport-belt/superior-transport-belt.png",
		priority = "extra-high",
		width = 64,
		height = 64,
		frame_count = 32,
		...
		hr_version =
		{
			filename = kr_entities_path .. "transport-belts/superior-transport-belt/hr-superior-transport-belt.png",
			priority = "extra-high",
			width = 128,
			height = 128,
			scale = 0.5,
