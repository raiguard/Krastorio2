...
data:extend({
  ...
  },
  {
    type = "item",
    name = "kr-medium-buffer-container",
    icon = "__Krastorio2Assets__/icons/entities/medium-buffer-container.png",
    subgroup = "kr-logistics-2",
    order = "c[medium-buffer-container]",
  ...
  },
  {
    ...
    picture = {
      filename = "__Krastorio2Assets__/entities/medium-buffer-container/medium-buffer-container.png",
      priority = "extra-high",
      width = 340,
      height = 340,
      scale = 0.25,
