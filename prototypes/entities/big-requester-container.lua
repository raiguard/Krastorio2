...
data:extend({
  ...
  },
  {
    type = "item",
    name = "kr-big-requester-container",
    icon = "__Krastorio2Assets__/icons/entities/big-requester-container.png",
    subgroup = "kr-logistics-3",
    order = "e[big-requester-container]",
  ...
  },
  {
    ...
    animation = {
      filename = "__Krastorio2Assets__/entities/big-requester-container/big-requester-container.png",
      priority = "extra-high",
      width = 512,
      height = 512,
      frame_count = 6,
