...
data:extend({
  ...
  },
  {
    type = "item",
    name = "kr-medium-active-provider-container",
    icon = "__Krastorio2Assets__/icons/entities/medium-active-provider-container.png",
    subgroup = "kr-logistics-2",
    order = "b[medium-active-provider-container]",
  ...
  },
  {
    ...
    picture = {
      filename = "__Krastorio2Assets__/entities/medium-active-provider-container/medium-active-provider-container.png",
      priority = "extra-high",
      width = 340,
      height = 340,
      scale = 0.25,
